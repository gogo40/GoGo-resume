...
No projeto X-Manager (`Jogo de negócios configurável X-Manager`_), eu desenvolvi, junto com meu sócio Huíran Fornazieri, um jogo de negócios configurável e uma rede social profissional. O objetivo desse projeto é fornecer um ambiente *gamificado* para treinamento em gestão de empresas.
